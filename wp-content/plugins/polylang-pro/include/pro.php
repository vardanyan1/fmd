...
add_action('init', function() {
  pll_register_string('slogan', 'slogan_footer');
});
...
add_action('init', function() {
  pll_register_string('enterkeywords', 'Enter Keywords');
});

add_action('init', function() {
  pll_register_string('terms', 'terms');
});

add_action('init', function() {
  pll_register_string('policy', 'policy');
});
...
add_action('init', function() {
  pll_register_string('company_name', 'company_name');
});

add_action('init', function() {
  pll_register_string('search_here', 'Search here...');
});