...
if (!function_exists('cmsmasters_fonts_list')) {
	function cmsmasters_fonts_list() {
		...
		if (isset($cmsmasters_option['fmd' . '_google_web_fonts']) && is_array($cmsmasters_option['fmd' . '_google_web_fonts'])) {
			$google_web_fonts_array = $cmsmasters_option['fmd' . '_google_web_fonts'];
...
if (!function_exists('cmsmasters_text_transform_list')) {
	function cmsmasters_text_transform_list() {
		$list = array( 
			...
			'uppercase' => esc_html__('uppercase', 'fmd'), 
			'lowercase' => esc_html__('lowercase', 'fmd'), 
			'capitalize' => esc_html__('capitalize', 'fmd'), 
		);
...
if (!function_exists('cmsmasters_image_thumbnail_list')) {
	function cmsmasters_image_thumbnail_list() {
		$list = alister_bank_get_image_thumbnail_list();
...
if (!function_exists('cmsmasters_color_schemes_list')) {
	function cmsmasters_color_schemes_list() {
		$list = alister_bank_all_color_schemes_list();
