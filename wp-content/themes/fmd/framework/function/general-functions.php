...
/* Register CSS Styles */
function alister_bank_register_css_styles() {
	if (!is_admin()) {
		global $post, 
			$wp_styles;
		...
		wp_enqueue_style('fmd-theme-style', get_template_directory_uri() . '/style.css', array(), '1.0.0', 'screen, print');
		
		wp_enqueue_style('fmd-style', get_template_directory_uri() . '/theme-framework/theme-style' . CMSMASTERS_THEME_STYLE . '/css/style.css', array(), '1.0.0', 'screen, print');
		
		wp_enqueue_style('fmd-adaptive', get_template_directory_uri() . '/theme-framework/theme-style' . CMSMASTERS_THEME_STYLE . '/css/adaptive.css', array(), '1.0.0', 'screen, print');
		
		wp_enqueue_style('fmd-retina', get_template_directory_uri() . '/theme-framework/theme-style' . CMSMASTERS_THEME_STYLE . '/css/retina.css', array(), '1.0.0', 'screen');
		
		
		if (is_rtl()) {
			wp_enqueue_style('fmd-rtl', get_template_directory_uri() . '/theme-framework/theme-style' . CMSMASTERS_THEME_STYLE . '/css/rtl.css', array(), '1.0.0', 'screen');
		}
		...
		// iLightBox skins
		$ilightbox_skin = $cmsmasters_option['fmd' . '_ilightbox_skin'];
		...
		if (is_dir($style_dir) && get_option('cmsmasters_style_exists_' . 'fmd')) {
			$cmsmasters_styles_dir = $upload_dir['baseurl'] . '/cmsmasters_styles/';
		}
		
		
		wp_enqueue_style('fmd-fonts-schemes', $cmsmasters_styles_dir . 'fmd' . '.css', array(), '1.0.0', 'screen');
	}
}

add_action('wp_enqueue_scripts', 'alister_bank_register_css_styles');



/* Register JS Scripts */
function alister_bank_register_js_scripts() {
	global $post;
	...
	$cmsmasters_localize_array = array( 
		...
		'project_puzzle_proportion' => 			alister_bank_project_puzzle_proportion(), 
		'gmap_api_key' => 						$cmsmasters_option['fmd' . '_gmap_api_key'], 
		'gmap_api_key_notice' => 				esc_html__('Please add your Google Maps API key', 'fmd'), 
		'gmap_api_key_notice_link' => 			esc_html__('read more how', 'fmd'), 
		'primary_color' => 						$cmsmasters_option['fmd' . '_default_link'], 
		'ilightbox_skin' => 					$cmsmasters_option['fmd' . '_ilightbox_skin'], 
		'ilightbox_path' => 					$cmsmasters_option['fmd' . '_ilightbox_path'], 
		'ilightbox_infinite' => 				$cmsmasters_option['fmd' . '_ilightbox_infinite'], 
		'ilightbox_aspect_ratio' => 			$cmsmasters_option['fmd' . '_ilightbox_aspect_ratio'], 
		'ilightbox_mobile_optimizer' => 		$cmsmasters_option['fmd' . '_ilightbox_mobile_optimizer'], 
		'ilightbox_max_scale' => 				$cmsmasters_option['fmd' . '_ilightbox_max_scale'], 
		'ilightbox_min_scale' => 				$cmsmasters_option['fmd' . '_ilightbox_min_scale'], 
		'ilightbox_inner_toolbar' => 			$cmsmasters_option['fmd' . '_ilightbox_inner_toolbar'], 
		'ilightbox_smart_recognition' => 		$cmsmasters_option['fmd' . '_ilightbox_smart_recognition'], 
		'ilightbox_fullscreen_one_slide' => 	$cmsmasters_option['fmd' . '_ilightbox_fullscreen_one_slide'], 
		'ilightbox_fullscreen_viewport' => 		$cmsmasters_option['fmd' . '_ilightbox_fullscreen_viewport'], 
		'ilightbox_controls_toolbar' => 		$cmsmasters_option['fmd' . '_ilightbox_controls_toolbar'], 
		'ilightbox_controls_arrows' => 			$cmsmasters_option['fmd' . '_ilightbox_controls_arrows'], 
		'ilightbox_controls_fullscreen' => 		$cmsmasters_option['fmd' . '_ilightbox_controls_fullscreen'], 
		'ilightbox_controls_thumbnail' => 		$cmsmasters_option['fmd' . '_ilightbox_controls_thumbnail'], 
		'ilightbox_controls_keyboard' => 		$cmsmasters_option['fmd' . '_ilightbox_controls_keyboard'], 
		'ilightbox_controls_mousewheel' => 		$cmsmasters_option['fmd' . '_ilightbox_controls_mousewheel'], 
		'ilightbox_controls_swipe' => 			$cmsmasters_option['fmd' . '_ilightbox_controls_swipe'], 
		'ilightbox_controls_slideshow' => 		$cmsmasters_option['fmd' . '_ilightbox_controls_slideshow'], 
		'ilightbox_close_text' => 				esc_html__('Close', 'fmd'), 
		'ilightbox_enter_fullscreen_text' => 	esc_html__('Enter Fullscreen (Shift+Enter)', 'fmd'), 
		'ilightbox_exit_fullscreen_text' => 	esc_html__('Exit Fullscreen (Shift+Enter)', 'fmd'), 
		'ilightbox_slideshow_text' => 			esc_html__('Slideshow', 'fmd'), 
		'ilightbox_next_text' => 				esc_html__('Next', 'fmd'), 
		'ilightbox_previous_text' => 			esc_html__('Previous', 'fmd'), 
		'ilightbox_load_image_error' => 		esc_html__('An error occurred when trying to load photo.', 'fmd'), 
		'ilightbox_load_contents_error' => 		esc_html__('An error occurred when trying to load contents.', 'fmd'), 
		'ilightbox_missing_plugin_error' => 	esc_html__("The content your are attempting to view requires the <a href='{pluginspage}' target='_blank'>{type} plugin<\/a>.", 'fmd') 
	);
	...
	wp_enqueue_script('fmd-script', get_template_directory_uri() . '/js/jquery.script.js', array('jquery'), '1.0.0', true);
	
	wp_localize_script('fmd-script', 'cmsmasters_script', $cmsmasters_localize_array);
	
	wp_enqueue_script('fmd-theme-script', get_template_directory_uri() . '/theme-framework/theme-style' . CMSMASTERS_THEME_STYLE . '/js/jquery.theme-script.js', array('jquery', 'fmd-script'), '1.0.0', true);
	...
	if ( 
		...
		isset($cmsmasters_option['fmd' . '_gmap_api_key']) && 
		$cmsmasters_option['fmd' . '_gmap_api_key'] != '' 
	) {
		wp_enqueue_script('gMapAPI', '//maps.googleapis.com/maps/api/js?key=' . $cmsmasters_option['fmd' . '_gmap_api_key'], array('jquery'), '1.0.0', true);
	...
	$cmsmasters_custom_js = stripslashes($cmsmasters_option['fmd' . '_custom_js']);
	
	wp_add_inline_script('fmd-script', $cmsmasters_custom_js);
...
add_action('wp_enqueue_scripts', 'alister_bank_register_js_scripts');



/* Fonts Generate Function */
if (!function_exists('alister_bank_theme_fonts_generate')) {

function alister_bank_theme_fonts_generate() {
	$cmsmasters_option = alister_bank_get_global_options();
	...
	foreach ($font_fields as $font_field) {
		$font_option = 'fmd' . '_' . $font_field . '_font_google_font';
...
add_action('wp_enqueue_scripts', 'alister_bank_theme_fonts_generate');
add_action('enqueue_block_editor_assets', 'alister_bank_theme_fonts_generate');
...
function cmsmasters_theme_font($fonts, $font_name = '') {
	...
	if ( 
		...
		if ($web_fonts != '') {
			...
			if (
				isset($cmsmasters_option['fmd' . '_google_web_fonts_subset']) && 
				is_array($cmsmasters_option['fmd' . '_google_web_fonts_subset'])
			) {
				$web_fonts_subset_array = $cmsmasters_option['fmd' . '_google_web_fonts_subset'];
			} else {
...
function alister_bank_get_google_font($font) {
	if ($font != '') {
		if (strpos($font, ':')) {
...
function alister_bank_the_widgets_init() {
    ...
    register_sidebar(
        array(
            'name' => esc_html__('Sidebar', 'fmd'), 
            'id' => 'sidebar_default', 
            'description' => esc_html__('Widgets in this area will be shown in all left and right sidebars till you don\'t use custom sidebar. To display the sidebar please choose the Right or Left Layout Type in the Theme Settings - General - Content options.', 'fmd'), 
    ...
    register_sidebar(
        array(
            'name' => esc_html__('Bottom Sidebar', 'fmd'), 
            'id' => 'sidebar_bottom', 
            'description' => esc_html__('Widgets in this area will be shown at the bottom of middle block below the content and middle sidebar, but above footer. To display Bottom Sidebar please enable it in the Theme Settings - General - Content - Bottom Sidebar Visibility by Default. You can also display it on concrete page in the Page Layout options.', 'fmd'), 
            'before_widget' => '<aside id="%1$s" class="widget %2$s">', 
            'after_widget' => '</aside>', 
            'before_title' => '<h3 class="widgettitle">', 
            'after_title' => '</h3>'
    ...
    register_sidebar(
        array(
            'name' => esc_html__('Archive Sidebar', 'fmd'), 
            'id' => 'sidebar_archive', 
            'description' => esc_html__('Widgets in this area will be shown in all left and right sidebars on archives pages. To display the sidebar please choose the Right or Left Layout Type in the Theme Settings - General - Content options.', 'fmd'), 
            'before_widget' => '<aside id="%1$s" class="widget %2$s">', 
            'after_widget' => '</aside>', 
            'before_title' => '<h3 class="widgettitle">', 
            'after_title' => '</h3>'
    ...
    register_sidebar(
        array(
            'name' => esc_html__('Search Sidebar', 'fmd'), 
            'id' => 'sidebar_search', 
            'description' => esc_html__('Widgets in this area will be shown in left or right sidebar on search page. To display the sidebar please choose the Right or Left Layout Type in the Theme Settings - General - Content options.', 'fmd'), 
            'before_widget' => '<aside id="%1$s" class="widget %2$s">', 
            'after_widget' => '</aside>', 
            'before_title' => '<h3 class="widgettitle">', 
            'after_title' => '</h3>'
	...
	if (isset($cmsmasters_option['fmd' . '_sidebar']) && sizeof($cmsmasters_option['fmd' . '_sidebar']) > 0) {
		foreach ($cmsmasters_option['fmd' . '_sidebar'] as $sidebar) {
			register_sidebar(array( 
				'name' => $sidebar, 
				'id' => generateSlug($sidebar, 45), 
				'description' => esc_html__('Custom sidebar created with cmsmasters admin panel.', 'fmd'), 
				'before_widget' => '<aside id="%1$s" class="widget %2$s">', 
				'after_widget' => '</aside>', 
				'before_title' => '<h3 class="widgettitle">', 
				'after_title' => '</h3>' 
...
add_action('widgets_init', 'alister_bank_the_widgets_init');



/* Register Showing Home Page on Default WordPress Pages Menu */
function alister_bank_page_menu_args($args) {
    $args['show_home'] = true;
...
add_filter('wp_page_menu_args', 'alister_bank_page_menu_args');
...
if (function_exists('add_theme_support')) {
	...
	function alister_bank_add_post_type_support_project($post) {
	...
	add_action('load-post.php', 'alister_bank_add_post_type_support_project');
	
	add_action('load-post-new.php', 'alister_bank_add_post_type_support_project');
	...
	add_filter('image_size_names_choose', 'alister_bank_select_image_size');
}



/* Add Image Thumbnails Size to the List */
function alister_bank_select_image_size($sizes) {
	$thumbnail_list = cmsmasters_image_thumbnail_list();
...
function alister_bank_add_editor_styles() {
...
if (version_compare($cmsmasters_wp_version, '5', '<') && !function_exists('is_gutenberg_page')) {
	add_action('init', 'alister_bank_add_editor_styles');
}



/* Register Removing 'More Text' From Excerpt */
function alister_bank_new_excerpt_more($more) {
	return '...';
}

add_filter('excerpt_more', 'alister_bank_new_excerpt_more');
...
function alister_bank_excerpt($length = 55, $show = true) {
	if ($show) {
...
function alister_bank_post_author_archive($query) {
...
add_action('pre_get_posts', 'alister_bank_post_author_archive');



/* Check Row p Wrapper */
function alister_bank_rowcheck($content) {
...
function alister_bank_generate_front_css() {
	$cmsmasters_page_id = alister_bank_get_singular_id();

	$shortcodes_css = get_post_meta($cmsmasters_page_id, 'cmsmasters_shortcodes_custom_css', true);
	
	
	wp_add_inline_style('fmd-retina', $shortcodes_css);
}

add_action('wp_enqueue_scripts', 'alister_bank_generate_front_css');
...
function alister_bank_add_global_icons() {
	...
	if ($wp_filesystem) {
		...
		update_option('cmsmasters_' . 'fmd' . '_icons', serialize($arr));
		
		update_option('cmsmasters_' . 'fmd' . '_icons_custom', serialize($arr_custom));
	}
}
...
function cmsmasters_composer_icons() {
	...
	if ( 
		...
		$icons = get_option('cmsmasters_' . 'fmd' . '_icons');
		
		$icons_custom = get_option('cmsmasters_' . 'fmd' . '_icons_custom');
		...
		} elseif (wp_script_is('fmd-lightbox-js', 'queue')) {
			wp_add_inline_script('fmd-lightbox-js', $out, 'before');
		}
	}
}
...
function alister_bank_regenerate_styles() {
	$custom_css_fonts = alister_bank_theme_fonts();
	
	$custom_css_colors_primary = alister_bank_theme_colors_primary();
	
	$custom_css_colors_secondary = alister_bank_theme_colors_secondary();
	
	
	$custom_css = $custom_css_fonts . $custom_css_colors_primary . $custom_css_colors_secondary;
	
	
	alister_bank_write_styles($custom_css);
}
...
function alister_bank_write_styles($styles, $filename = '') {
	$upload_dir = wp_upload_dir();
	...
	$is_dir = alister_bank_create_folder($style_dir);
	
	
	if ($is_dir === false) {
		update_option('cmsmasters_style_dir_writable_' . 'fmd', 'false');
		
		update_option('cmsmasters_style_exists_' . 'fmd', 'false');
	...
	$file = trailingslashit($style_dir) . (($filename != '') ? $filename : 'fmd') . '.css';
	
	
	$created = alister_bank_create_file($file, $styles);
	
	
	if ($created === true) {
		update_option('cmsmasters_style_dir_writable_' . 'fmd', 'true');
		
		update_option('cmsmasters_style_exists_' . 'fmd', 'true');
	}
}
...
function alister_bank_create_folder(&$folder, $addindex = true) {
...
function alister_bank_create_file($file, $content = '', $verifycontent = true) {
	global $wp_filesystem;
...
function cmsmasters_get_tweets( $username, $count ) {
	$backup_name = 'cmsmasters_' . 'fmd' . '_tweets_list_backup';

	$backup_tweets = get_option( $backup_name );

	if ( 'done' === get_transient( 'cmsmasters_' . 'fmd' . '_tweets_list_regeneration' ) && ! empty( $backup_tweets ) ) {
		return $backup_tweets;
	}

	$cmsmasters_option = alister_bank_get_global_options();

	if ( empty( $cmsmasters_option['fmd' . '_twitter_access_token'] ) ) {
		return $backup_tweets;
	}
	...
	$response = wp_remote_get(
		...
		array(
			'headers' => array(
				'Authorization' => 'Bearer ' . esc_html( $cmsmasters_option['fmd' . '_twitter_access_token'] ),
			),
			'body' => array(
	...
	set_transient( 'cmsmasters_' . 'fmd' . '_tweets_list_regeneration', 'done', HOUR_IN_SECONDS * 6 );
...
/* Get Singular ID */
function alister_bank_get_singular_id() {
	$id = false;
...
function alister_bank_theme_bg_styles() {
	$cmsmasters_option = alister_bank_get_global_options();
	...
	if ($cmsmasters_option['fmd' . '_theme_layout'] == 'boxed') {
		...
		if ($cmsmasters_bg_default == 'false') {
			...
			$cmsmasters_bg_col = $cmsmasters_option['fmd' . '_bg_col'];
			$cmsmasters_bg_img_enable = $cmsmasters_option['fmd' . '_bg_img_enable'];
			$cmsmasters_bg_img_str = $cmsmasters_option['fmd' . '_bg_img'];
			$cmsmasters_bg_pos = $cmsmasters_option['fmd' . '_bg_pos'];
			$cmsmasters_bg_rep = $cmsmasters_option['fmd' . '_bg_rep'];
			$cmsmasters_bg_att = $cmsmasters_option['fmd' . '_bg_att'];
			$cmsmasters_bg_size = $cmsmasters_option['fmd' . '_bg_size'];
		}
	...
	wp_add_inline_style('fmd-style', $out);
}

add_action('wp_enqueue_scripts', 'alister_bank_theme_bg_styles');



/* Get Logo Function */
function alister_bank_logo() {
	$cmsmasters_option = alister_bank_get_global_options();
	
	
	if ($cmsmasters_option['fmd' . '_logo_type'] == 'text') {
		if ($cmsmasters_option['fmd' . '_logo_title'] != '') {
			$blog_title = stripslashes($cmsmasters_option['fmd' . '_logo_title']);
		} else {
			$blog_title = (get_bloginfo('name')) ? get_bloginfo('name') : 'Alister Bank';
		}
		
		
		if ($cmsmasters_option['fmd' . '_logo_subtitle'] != '') {
			$blog_descr = stripslashes($cmsmasters_option['fmd' . '_logo_subtitle']);
		} else {
			$blog_descr = (get_bloginfo('description')) ? get_bloginfo('description') : esc_html__('Default Logo Subtitle', 'fmd');
		}
		...
		echo '<a href="' . esc_url(home_url('/')) . '" title="' . esc_attr($blog_title) . '" class="logo">' . "\n\t" . 
			'<span class="logo_text_wrap">' . 
				...
				($cmsmasters_option['fmd' . '_logo_subtitle'] ? '<span class="title_text">' . esc_html($blog_descr) . '</span>' : '') . 
			'</span>' . 
		'</a>';
	} else {
		...
		if ($cmsmasters_option['fmd' . '_logo_url'] == '') {
			...
			$logo_img = explode('|', $cmsmasters_option['fmd' . '_logo_url']);
			...
			if ($cmsmasters_option['fmd' . '_logo_url_retina'] != '') {
				$logo_img_retina = explode('|', $cmsmasters_option['fmd' . '_logo_url_retina']);
...
/* Logo Styles */
function alister_bank_theme_logo_styles() {
	$cmsmasters_option = alister_bank_get_global_options();
	...
	if ($cmsmasters_option['fmd' . '_logo_type'] == 'text') {
		if ($cmsmasters_option['fmd' . '_logo_custom_color']) {
			$out .= "
				#header a.logo span.title {
					" . cmsmasters_color_css('color', $cmsmasters_option['fmd' . '_logo_title_color']) . "
				}
				
				#header a.logo span.title_text {
					" . cmsmasters_color_css('color', $cmsmasters_option['fmd' . '_logo_subtitle_color']) . "
				}
			";
		}
	} else {
		...
		$header_mid_height = (($cmsmasters_option['fmd' . '_header_mid_height'] !== '') ? $cmsmasters_option['fmd' . '_header_mid_height'] : $defaults[$tab]['fmd' . '_header_mid_height']);
...
add_action('wp_enqueue_scripts', 'alister_bank_theme_logo_styles');



/* Get Footer Logo Function */
function alister_bank_footer_logo($cmsmasters_option) {
	...
	if ($cmsmasters_option['fmd' . '_footer_logo_url'] == '') {
		...
		$footer_logo_img = explode('|', $cmsmasters_option['fmd' . '_footer_logo_url']);
		...
		if ($cmsmasters_option['fmd' . '_footer_logo_url_retina'] != '') {
			$footer_logo_img_retina = explode('|', $cmsmasters_option['fmd' . '_footer_logo_url_retina']);
...
function alister_bank_social_icons() {
	$out = '';
...
<div class=\"social_wrap\">
	<div class=\"social_wrap_inner\">
		...
		foreach ($cmsmasters_option['fmd' . '_social_icons'] as $cmsmasters_social_icons) {
...
function alister_bank_get_comments($class = false, $show = false, $add_html = false) { 
	$out = '';
	
	if ($add_html) {
		$text = (get_comments_number() == '1') ? esc_html__('comment', 'fmd') : esc_html__('comments', 'fmd');
	} else {
		$text = '';
	}
	...
	if (comments_open()) {
		$out .= '<span class="cmsmasters_comments' . ($class ? ' ' . $class : '') . '">' . 
			'<a class="cmsmasters_theme_icon_comment" href="' . esc_url(get_comments_link()) . '" title="' . esc_attr__('Comment on', 'fmd') . ' ' . esc_attr(get_the_title()) . '">' . 
...
/* Get Category List */
function alister_bank_get_the_category_list($cmsmasters_id, $taxonomy, $sep = '', $before = '', $after = '', $taxonomy_class = false) {
...
function alister_bank_theme_page_layout_scheme() {
	$cmsmasters_option = alister_bank_get_global_options();
	...
	} elseif (CMSMASTERS_TRIBE_EVENTS && tribe_is_event_query() && isset($cmsmasters_option['fmd' . '_events_layout'])) {
		$cmsmasters_layout = $cmsmasters_option['fmd' . '_events_layout'];
	} elseif (is_archive() || is_home()) {
		$cmsmasters_layout = $cmsmasters_option['fmd' . '_archives_layout'];
	} elseif (is_search()) {
		$cmsmasters_layout = $cmsmasters_option['fmd' . '_search_layout'];
	} else {
		$cmsmasters_layout = $cmsmasters_option['fmd' . '_other_layout'];
	}
	
	
	if ($cmsmasters_layout == '') {
		$cmsmasters_layout = $cmsmasters_option['fmd' . '_layout'];
	}
...
/* Return content */
function alister_bank_return_content($content) {
	return $content;
}
...
function alister_bank_global_shortcodes_styles_move($content) {
	return preg_replace("/(?<!['\"])<style.*?>([^`]*?)<\/style>/", '', $content);
}


function alister_bank_row_checker($data) {
	$out = alister_bank_rowcheck($data);
	
	return $out;
}

add_filter('the_content', 'alister_bank_row_checker', 10, 2);
	...
	if( wp_verify_nonce($nonce, 'cmsmasters_ajax_like-nonce') ){
		...
		if ($post_ID != '') {
			...
			if (isset($_COOKIE['like-' . $post_ID]) || count($ipCheck) != 0) {
				...
				if ($add_html == 'true') {
					$text = ($plusLike == '1') ? esc_html__('like', 'fmd') : esc_html__('likes', 'fmd');
				} else {
					$text = '';
				}
...
function cmsmasters_ajax_apply_theme_style_callback() {
	...
	if (wp_verify_nonce($nonce, 'cmsmasters_ajax_apply_theme_style-nonce')) {
		if (isset($_POST['theme_style'])) {
			update_option('cmsmasters_fmd_theme_style', $_POST['theme_style']);

			update_option('cmsmasters_fmd_theme_style_change', 'change');
		}
...
function alister_bank_theme_style_change() {
	if (!CMSMASTERS_THEME_STYLE_COMPATIBILITY) {
		update_option('cmsmasters_fmd_theme_style', '');

		return;
	}

	if ('hold' === get_option('cmsmasters_fmd_theme_style_change')) {
		return;
	} else {
		...
		update_option('cmsmasters_fmd_theme_style_change', 'hold');
	}
}

add_action('init', 'alister_bank_theme_style_change');
...
function cmsmasters_ajax_reset_settings_callback() {
	...
	if (wp_verify_nonce($nonce, 'cmsmasters_ajax_reset_settings-nonce')) {
		alister_bank_add_global_options(true);
...
function cmsmasters_ajax_export_settings_callback() {
	...
	if (wp_verify_nonce($nonce, 'cmsmasters_ajax_export_settings-nonce')) {
		$cmsmasters_global_settings = array( 
			'cmsmasters_options_' . 'fmd' . CMSMASTERS_THEME_STYLE . '_general', 
			'cmsmasters_options_' . 'fmd' . CMSMASTERS_THEME_STYLE . '_bg', 
			'cmsmasters_options_' . 'fmd' . CMSMASTERS_THEME_STYLE . '_header', 
			'cmsmasters_options_' . 'fmd' . CMSMASTERS_THEME_STYLE . '_content', 
			'cmsmasters_options_' . 'fmd' . CMSMASTERS_THEME_STYLE . '_footer', 
			'cmsmasters_options_' . 'fmd' . CMSMASTERS_THEME_STYLE . '_font_content', 
			'cmsmasters_options_' . 'fmd' . CMSMASTERS_THEME_STYLE . '_font_link', 
			'cmsmasters_options_' . 'fmd' . CMSMASTERS_THEME_STYLE . '_font_nav', 
			'cmsmasters_options_' . 'fmd' . CMSMASTERS_THEME_STYLE . '_font_heading', 
			'cmsmasters_options_' . 'fmd' . CMSMASTERS_THEME_STYLE . '_font_other', 
			'cmsmasters_options_' . 'fmd' . CMSMASTERS_THEME_STYLE . '_element_sidebar', 
			'cmsmasters_options_' . 'fmd' . CMSMASTERS_THEME_STYLE . '_element_icon', 
			'cmsmasters_options_' . 'fmd' . CMSMASTERS_THEME_STYLE . '_element_lightbox', 
			'cmsmasters_options_' . 'fmd' . CMSMASTERS_THEME_STYLE . '_element_sitemap', 
			'cmsmasters_options_' . 'fmd' . CMSMASTERS_THEME_STYLE . '_element_error', 
			'cmsmasters_options_' . 'fmd' . CMSMASTERS_THEME_STYLE . '_element_code', 
			'cmsmasters_options_' . 'fmd' . CMSMASTERS_THEME_STYLE . '_element_recaptcha', 
			'cmsmasters_options_' . 'fmd' . CMSMASTERS_THEME_STYLE . '_single_post', 
			'cmsmasters_options_' . 'fmd' . CMSMASTERS_THEME_STYLE . '_single_project', 
			'cmsmasters_options_' . 'fmd' . CMSMASTERS_THEME_STYLE . '_single_profile'
		);
		...
		foreach (alister_bank_all_color_schemes_list() as $key => $value) {
			$cmsmasters_global_colors[] = 'cmsmasters_options_' . 'fmd' . CMSMASTERS_THEME_STYLE . '_color_' . $key;
		}
		...
		echo alister_bank_return_content($result);
