...
function alister_bank_gutenberg_module_colors($custom_css = '', $is_editor = false) {
...
/***************** Start Gutenberg Module Custom Colors Scheme Rules ******************/
	...
	{$editor} div.wp-block ul > li:before {
		" . cmsmasters_color_css('background-color', $cmsmasters_option['fmd' . '_default_border']) . "
	}
	
	{$editor} .wp-block-quote,
	.editor-styles-wrapper .wp-block-freeform blockquote,
	.editor-styles-wrapper .wp-block-freeform blockquote p {
		" . cmsmasters_color_css('color', $cmsmasters_option['fmd' . '_default_heading']) . "
	}
	...
	.editor-styles-wrapper .wp-block-freeform table tbody tr td {
		" . cmsmasters_color_css('border-color', $cmsmasters_option['fmd' . '_default_border']) . "
	}
	
	{$editor} .wp-block-table.is-style-stripes tr:nth-child(odd) th,
	{$editor} .wp-block-table.is-style-stripes tr:nth-child(odd) td {
		" . cmsmasters_color_css('background-color', $cmsmasters_option['fmd' . '_default_alternate']) . "
	}
	...
	{$editor} .wp-block-freeform.mce-content-body > table thead td {
		" . cmsmasters_color_css('background-color', $cmsmasters_option['fmd' . '_default_secondary']) . "
		" . cmsmasters_color_css('border-color', $cmsmasters_option['fmd' . '_default_secondary']) . "
	}
	...
	{$editor} .wp-block-freeform.mce-content-body > table thead th,
	{$editor} .wp-block-freeform.mce-content-body > table thead td {
		" . cmsmasters_color_css('color', $cmsmasters_option['fmd' . '_default_bg']) . "
	}
	/* Finish Table Colors */
...
/***************** Start Gutenberg Module General Colors Scheme Rules ******************/
	...
	{$editor} .wp-block-latest-comments .wp-block-latest-comments__comment-date {
		" . cmsmasters_color_css('color', $cmsmasters_option['fmd' . '_default_color']) . "
	}
	...
	.editor-styles-wrapper .wp-block-file .wp-block-file__textlink .editor-rich-text__tinymce {
		" . cmsmasters_color_css('color', $cmsmasters_option['fmd' . '_default_link']) . "
	}
	...
	.editor-styles-wrapper div.wp-block .wp-block-freeform.block-library-rich-text__tinymce a:active {
		" . cmsmasters_color_css('color', $cmsmasters_option['fmd' . '_default_hover']) . "
	}
	
	.editor-styles-wrapper select:focus {
		" . cmsmasters_color_css('border-color', $cmsmasters_option['fmd' . '_default_hover']) . "
	}
	...
	{$editor} .wp-block-pullquote.is-style-solid-color {
		" . cmsmasters_color_css('background-color', $cmsmasters_option['fmd' . '_default_heading']) . "
	}
	
	{$editor} .wp-block-pullquote {
		" . cmsmasters_color_css('border-color', $cmsmasters_option['fmd' . '_default_heading']) . "
	}
	...
	body .editor-styles-wrapper,
	.editor-styles-wrapper select {
		" . cmsmasters_color_css('background-color', $cmsmasters_option['fmd' . '_default_bg']) . "
	}
	...
	{$editor} .wp-block-separator.is-style-dots:before {
		" . cmsmasters_color_css('color', $cmsmasters_option['fmd' . '_default_border']) . "
	}
	...
	{$editor} .wp-block-file a.wp-block-file__button {
		" . cmsmasters_color_css('color', $cmsmasters_option['fmd' . '_default_bg']) . "
		" . cmsmasters_color_css('background-color', $cmsmasters_option['fmd' . '_default_link']) . "
	}
	...
	{$editor} .wp-block-file a.wp-block-file__button:active {
		" . cmsmasters_color_css('color', $cmsmasters_option['fmd' . '_default_bg']) . "
		" . cmsmasters_color_css('background-color', $cmsmasters_option['fmd' . '_default_hover']) . "
	}
	
	{$editor} .wp-block-button.is-style-outline .wp-block-button__link:not(.has-text-color):not(.has-background) {
		" . cmsmasters_color_css('color', $cmsmasters_option['fmd' . '_default_link']) . "
		" . cmsmasters_color_css('background-color', $cmsmasters_option['fmd' . '_default_bg']) . "
		" . cmsmasters_color_css('border-color', $cmsmasters_option['fmd' . '_default_link']) . "
	}
...
add_filter('alister_bank_theme_colors_secondary_filter', 'alister_bank_gutenberg_module_colors');
