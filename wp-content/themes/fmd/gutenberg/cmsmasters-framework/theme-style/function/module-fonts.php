...
function alister_bank_gutenberg_module_fonts($custom_css = '', $is_editor = false) {
...
/***************** Start Gutenberg Module General Font Styles ******************/
	...
	{$editor} .wp-block-quote.is-large,
	{$editor} .wp-block-quote.is-style-large {
		font-size:" . ((int) $cmsmasters_option['fmd' . '_quote_font_font_size'] + 4) . "px;
		line-height:" . ((int) $cmsmasters_option['fmd' . '_quote_font_line_height'] + 4) . "px;
	}
...
add_filter('alister_bank_theme_fonts_filter', 'alister_bank_gutenberg_module_fonts');
