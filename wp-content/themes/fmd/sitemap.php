...
if ($cmsmasters_option['fmd' . '_sitemap_nav']) { 
	echo '<h1>' . esc_html__('Website Pages', 'fmd') . '</h1>';
...
if ($cmsmasters_option['fmd' . '_sitemap_categs']) {
	echo '<div class="cmsmasters_divider solid"></div>' . 
	'<h1>' . esc_html__('Blog Archives by Categories', 'fmd') . '</h1>' . 
...
if ($cmsmasters_option['fmd' . '_sitemap_tags']) {
	$tags = get_tags(array( 
		'orderby' => 'name', 
		'order' => 'DESC' 
	));
	...
	echo '<div class="cmsmasters_divider solid"></div>' . 
	'<h1>' . esc_html__('Blog Archives by Tags', 'fmd') . '</h1>' . 
...
if ($cmsmasters_option['fmd' . '_sitemap_month']) {
	echo '<div class="cmsmasters_divider solid"></div>' . 
	'<h1>' . esc_html__('Blog Archives by Month', 'fmd') . '</h1>' . 
	'<ul class="cmsmasters_sitemap_archive">';
...
if ($cmsmasters_option['fmd' . '_sitemap_pj_categs']) {
	echo '<div class="cmsmasters_divider solid"></div>' . 
	'<h1>' . esc_html__('Portfolio Archives by Categories', 'fmd') . '</h1>' . 
	'<ul class="cmsmasters_sitemap_category">';
...
if ($cmsmasters_option['fmd' . '_sitemap_pj_tags']) {
	echo '<div class="cmsmasters_divider solid"></div>' . 
	'<h1>' . esc_html__('Portfolio Archives by Tags', 'fmd') . '</h1>' . 
	'<ul class="cmsmasters_sitemap_archive">';
	...
	wp_list_categories(array( 
		...
		'hierarchical' => false, 
		'taxonomy' => 'pj-tags',
		'show_option_none' => esc_html__('No tags', 'fmd')
	));
